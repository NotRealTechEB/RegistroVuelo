...
public record UpdateRegistroVuelo (
    ...
    //ID Registro de vuelo
    @NotNull(message="Debe ingresar el ID de Registro de vuelo") 
    @Positive(message="El ID Plan de vuelo no puede ser negativo o cero")Integer idRV,
